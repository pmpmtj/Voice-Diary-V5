...
def process_files(client, files, output_path, batch_output_path):
    ...
    for file_path in files:
        ...
        # Transcribe the file
        transcription = transcribe_file(client, file_path)
...
def run_transcribe():
    ...
    try:
        ...
        # Process the files
        results = process_files(client, files, output_path, batch_output_path)
